...
namespace DCLExport
{
    public class DclExporter : EditorWindow
    {
        ...
        {
            UnityWebRequestAsyncOperation webRequest = UnityWebRequest.Get(uri).SendWebRequest();
            webRequest.completed += (asyncOperation) =>
            {
                Debug.Log("Log Inside Request");
                Debug.Log(webRequest.webRequest.downloadHandler.text); //
            };
        }
        ...
        private void SetDayTime()
        {
            ...
            if (GUILayout.Button("00:00"))
            {
                ...
                light.transform.rotation = Quaternion.Euler(183, -45, -90);
                light.color = new Color(0.686f, 0.655f, 0.738f);
                light.intensity = 0.2f;
                light.shadows = LightShadows.None;

                RenderSettings.skybox.SetTexture("_Tex", Resources.Load<Cubemap>("Skybox/00h"));
                RenderSettings.ambientMode = UnityEngine.Rendering.AmbientMode.Trilight;
                RenderSettings.ambientSkyColor = new Color(0.604f, 0.530f, 0.943f);
                RenderSettings.ambientEquatorColor = new Color(0.726f, 0.541f, 0.932f);
                RenderSettings.ambientGroundColor = new Color(0.213f, 0.040f, 0.471f);
                RenderSettings.fog = true;
                RenderSettings.fogStartDistance = 0;
                RenderSettings.fogEndDistance = 800;
                RenderSettings.fogColor = new Color(0.161f, 0.093f, 0.330f);
            }
            if (GUILayout.Button("04:00"))
            {
                Light light = FindFirstObjectByType<Light>();
                light.transform.rotation = Quaternion.Euler(183, -45, -90);
                light.color = new Color(0.692f, 0.538f, 0.934f);
                light.intensity = 0.652f;
                light.shadows = LightShadows.Soft;

                RenderSettings.skybox.SetTexture("_Tex" , Resources.Load<Cubemap>("Skybox/04h"));
                RenderSettings.ambientMode = UnityEngine.Rendering.AmbientMode.Trilight;
                RenderSettings.ambientSkyColor = new Color(0.899f, 0.878f, 0.917f);
                RenderSettings.ambientEquatorColor = new Color(0.880f, 0.661f, 0.531f);
                RenderSettings.ambientGroundColor = new Color(0.528f, 0.324f, 0.512f);
                RenderSettings.fog = true;
                RenderSettings.fogStartDistance = 0;
                RenderSettings.fogEndDistance = 800;
                RenderSettings.fogColor = new Color(0.432f, 0.427f, 0.389f);
            }
            if (GUILayout.Button("08:00"))
            {
                Light light = FindFirstObjectByType<Light>();
                light.transform.rotation = Quaternion.Euler(152, -45, -90);
                light.color = new Color(0.767f, 0.732f, 0.638f);
                light.intensity = 1.1f;
                light.shadows = LightShadows.Soft;

                RenderSettings.skybox.SetTexture("_Tex", Resources.Load<Cubemap>("Skybox/08h"));
                RenderSettings.ambientMode = UnityEngine.Rendering.AmbientMode.Trilight;
                RenderSettings.ambientSkyColor = new Color(0.992f, 0.816f, 0.640f);
                RenderSettings.ambientEquatorColor = new Color(0.718f, 0.774f, 0.841f);
                RenderSettings.ambientGroundColor = new Color(0.818f, 0.523f, 0.272f);
                RenderSettings.fog = true;
                RenderSettings.fogStartDistance = 0;
                RenderSettings.fogEndDistance = 800;
                RenderSettings.fogColor = new Color(0.517f, 0.572f, 0.382f);
            }
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.BeginHorizontal();
            ...
            {
                Light light = FindFirstObjectByType<Light>();
                light.transform.rotation = Quaternion.Euler(89, -45, -90);
                light.color = new Color(0.852f, 0.838f, 0.797f);
                light.intensity = 1.3f;
                light.shadows = LightShadows.Soft;

                RenderSettings.skybox.SetTexture("_Tex", Resources.Load<Cubemap>("Skybox/12h"));
                RenderSettings.ambientMode = UnityEngine.Rendering.AmbientMode.Trilight;
                RenderSettings.ambientSkyColor = new Color(0.954f, 0.789f, 0.678f);
                RenderSettings.ambientEquatorColor = new Color(0.942f, 0.858f, 0.783f);
                RenderSettings.ambientGroundColor = new Color(0.304f, 0.320f, 0.352f);
                RenderSettings.fog = true;
                RenderSettings.fogStartDistance = 0;
                RenderSettings.fogEndDistance = 800;
                RenderSettings.fogColor = new Color(0.414f, 0.528f, 0.312f);
            }
            if (GUILayout.Button("16:00"))
            {
                Light light = FindFirstObjectByType<Light>();
                light.transform.rotation = Quaternion.Euler(46, -45, -90);
                light.color = new Color(0.859f, 0.788f, 0.641f);
                light.intensity = 1.2f;
                light.shadows = LightShadows.Soft;

                RenderSettings.skybox.SetTexture("_Tex", Resources.Load<Cubemap>("Skybox/16h"));
                RenderSettings.ambientMode = UnityEngine.Rendering.AmbientMode.Trilight;
                RenderSettings.ambientSkyColor = new Color(0.917f, 0.785f, 0.683f);
                RenderSettings.ambientEquatorColor = new Color(0.866f, 0.797f, 0.721f);
                RenderSettings.ambientGroundColor = new Color(0.740f, 0.550f, 0.414f);
                RenderSettings.fog = true;
                RenderSettings.fogStartDistance = 0;
                RenderSettings.fogEndDistance = 800;
                RenderSettings.fogColor = new Color(0.484f, 0.517f, 0.409f);
            }
            if (GUILayout.Button("20:00"))
            {
                Light light = FindFirstObjectByType<Light>();
                light.transform.rotation = Quaternion.Euler(6, -45, -90);
                light.color = new Color(0.798f, 0.583f, 0.284f);
                light.intensity = 1f;
                light.shadows = LightShadows.Soft;

                RenderSettings.skybox.SetTexture("_Tex", Resources.Load<Cubemap>("Skybox/20h"));
                RenderSettings.ambientMode = UnityEngine.Rendering.AmbientMode.Trilight;
                RenderSettings.ambientSkyColor = new Color(0.819f, 0.715f, 0.744f);
                RenderSettings.ambientEquatorColor = new Color(0.824f, 0.712f, 0.732f);
                RenderSettings.ambientGroundColor = new Color(0.742f, 0.575f, 0.725f);
                RenderSettings.fog = true;
                RenderSettings.fogStartDistance = 0;
                RenderSettings.fogEndDistance = 800;
                RenderSettings.fogColor = new Color(0.420f, 0.391f, 0.437f);
            }
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.EndVertical();
        }
        ...
        private void DclPathGUI()
        {
            ...
            if (GUILayout.Button("Set Folder Root", GUILayout.Height(24)))
            {
            ...
            if (GUILayout.Button("Create Folder In", GUILayout.Height(24)))
            {
                newExportPath = EditorUtility.OpenFolderPanel("Select the folder location", exportPath, "");
        ...
        {
            if (exportPath.Contains("/NewDclProject_"))
                exportPath.Replace("/NewDclProject_" + i.ToString(), "");

            if (string.IsNullOrEmpty(newExportPath))
                return;

            newExportPath = newExportPath + "/NewDclProject_" + i.ToString();

            if (Directory.Exists(newExportPath))
            {
                newExportPath = newExportPath.Replace("/NewDclProject_" + i.ToString(), "");
                i++;
        ...
        private void Export(bool exportScripts = true, bool exportModels = true, bool exportMetadata = true)
        {
            ...
            exportStr.Prepend("import { TagComponent } from './imports/components/tag';\n\n");

...
public class Force_GLTF : MonoBehaviour
{
    ...
    public void BuildForced_GLTF()
    {
        if (!GetComponent<MeshRenderer>())
        {
            ...
            gameObject.GetComponent<MeshRenderer>().sharedMaterial = new Material(Shader.Find("Universal Render Pipeline/Lit")); //sharedMaterial.shader.name.Contains("Universal Render Pipeline/PolyShader")
            //this.gameObject.GetComponent<MeshRenderer>().sharedMaterial.shader = Shader.Find("Universal Render Pipeline/Lit");
